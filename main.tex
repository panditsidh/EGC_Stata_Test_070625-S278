...
\begin{table}[H]
    ...
    \resizebox{\textwidth}{!}{\input{tables/table01_summary}}
    \caption{: Endline raw data summary statistics}
\end{table}


The average per-capita income for households in the sample is \$6.29 a day (using the provided exchange rate).
...
\begin{table}[H]
    ...
    \setlength{\tabcolsep}{2pt}
    \renewcommand{\arraystretch}{2}
    \resizebox{\textwidth}{!}{\input{tables/table02_balance}}
    \caption{: Endline raw data summary statistics}
\end{table}
